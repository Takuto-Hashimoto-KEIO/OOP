% task開始から5秒間での平均脳波パワーを、他のランダムなtask時間からのパワーと並べ替え検定
function kentei_C3_C4_task_start_5s(frqfiled_all, keystroke_data, success_duration_end_time, success_duration_end_idx, savePath, cfg)

% 関心trialの決定
target_color = 2; % 打鍵成功持続時間：1なら18秒以上、3なら5秒未満、2ならその間、4なら編集せずそのまま全体を返す
...
for trial = 1:num_trials
    time_point = end_idx; % もつれの時刻 (サンプル番号)
...
title(sprintf('打鍵開始0～1秒間の並び替え検定 非制御半球'));
