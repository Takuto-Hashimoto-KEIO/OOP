...
function [med_env_data, med_rand_env_data, num_miss_trials] = generate_misstap_EEG_data_all_ch_ver( ...
    EEG_data, first_misstap_time, num_trials)
...
elec = 1; % 関心chは一つだけ、そもそも電極1つ分しか入力してない
