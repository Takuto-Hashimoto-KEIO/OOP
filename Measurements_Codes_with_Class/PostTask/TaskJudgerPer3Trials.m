classdef TaskJudgerPer3Trials
    ...
    methods
        function obj = TaskJudgerPer3Trials(current_trial, interval_index, success_duration, tap_interval_list, trial_task_time)
    ...
    methods (Access = private)
        ...
        function determined_interval_index = determine_interval_index(obj)
            if all(obj.mean_success_durations < obj.trial_task_time*0.75)
